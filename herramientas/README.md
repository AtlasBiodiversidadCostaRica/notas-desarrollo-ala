...
```
**NOTA:** En el caso del software de ALA, las versiones de Gradle y Grails puede verse en los archivos ```application.properties``` o ```gradle.properties```. Por ejemplo en:
